...
wb_mux
 ...
 wb_mux_dbus
   (.wb_clk_i  (wb_clk_i),
    ...
    .wbs_adr_o ({wb_sdram_dbus_adr_o, wb_m2s_resize_uart0_adr, wb_m2s_resize_gpio0_adr}),
    .wbs_dat_o ({wb_sdram_dbus_dat_o, wb_m2s_resize_uart0_dat, wb_m2s_resize_gpio0_dat}),
    .wbs_sel_o ({wb_sdram_dbus_sel_o, wb_m2s_resize_uart0_sel, wb_m2s_resize_gpio0_sel}),
    .wbs_we_o  ({wb_sdram_dbus_we_o, wb_m2s_resize_uart0_we, wb_m2s_resize_gpio0_we}),
    .wbs_cyc_o ({wb_sdram_dbus_cyc_o, wb_m2s_resize_uart0_cyc, wb_m2s_resize_gpio0_cyc}),
    .wbs_stb_o ({wb_sdram_dbus_stb_o, wb_m2s_resize_uart0_stb, wb_m2s_resize_gpio0_stb}),
    .wbs_cti_o ({wb_sdram_dbus_cti_o, wb_m2s_resize_uart0_cti, wb_m2s_resize_gpio0_cti}),
    .wbs_bte_o ({wb_sdram_dbus_bte_o, wb_m2s_resize_uart0_bte, wb_m2s_resize_gpio0_bte}),
    .wbs_dat_i ({wb_sdram_dbus_dat_i, wb_s2m_resize_uart0_dat, wb_s2m_resize_gpio0_dat}),
    .wbs_ack_i ({wb_sdram_dbus_ack_i, wb_s2m_resize_uart0_ack, wb_s2m_resize_gpio0_ack}),
    .wbs_err_i ({wb_sdram_dbus_err_i, wb_s2m_resize_uart0_err, wb_s2m_resize_gpio0_err}),
    .wbs_rty_i ({wb_sdram_dbus_rty_i, wb_s2m_resize_uart0_rty, wb_s2m_resize_gpio0_rty}));
